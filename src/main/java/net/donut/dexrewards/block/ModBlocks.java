...
//    public static final Block Raw_Dex_Block = registerBlock("raw_dex_block", new Block(FabricBlockSettings.copyOf(Blocks.RAW_IRON_BLOCK)));
    ...
    public static final Block DEX_MAP_BLOCK = registerBlock("dex_map_block", new DexMapBlock(FabricBlockSettings.copyOf(Blocks.RAW_IRON_BLOCK)));
    ...
    public static final Block ARCHEO_BLOCK = registerBlock("archaeo_block", new Block(FabricBlockSettings.copyOf(Blocks.FLETCHING_TABLE)));
